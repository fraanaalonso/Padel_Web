...
<form method="post" id="formulario_registro"class="needs-validation" novalidate>
  <div class="form-row">
    ...
    <div class="col-md-4 mb-3">
      ...
      <div class="input-group">
        ...
        <input type="text" class="form-control" id="validationCustomUsername" placeholder="Login" aria-describedby="inputGroupPrepend" required>
  ...
  <div class="form-row">
    <div class="col-md-6 mb-3">
      ...
      <div class="invalid-feedback">
        Por favor, indique su ciudad de origen!
      </div>
    </div>
    <div class="col-md-3 mb-3">
      ...
      <div class="invalid-feedback">
        Por favot, indique su estado de origen!
      </div>
    </div>
    <div class="col-md-3 mb-3">
